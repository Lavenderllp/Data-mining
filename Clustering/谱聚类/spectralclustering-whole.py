...
start = datetime.now()
inputfile = 'Wholesale customers data.csv'
outputfile = 'out_Wholesale customers data.csv'
...
#返回分类标签
pred_y = SpectralClustering(n_clusters=7,gamma=0.01,affinity='rbf').fit_predict(x_data)
